...
STATIC_URL = '/static/'
STATICFILES_DIRS = [str(BASE_DIR.joinpath('parte2/static'))]  # novo se a pasta static estiver na pasta da aplicação app, altere para str(BASE_DIR.joinpath('app/static'))
